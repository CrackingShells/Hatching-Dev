...
hatch_mcp = HatchMCP("base_pkg_1",
                origin_citation="Base package 1 for testing adding a version bump.",
                mcp_citation="Base package 1 MCP implementation v1.1.0")
...
def base_function(param: str) -> str:
    ...
    return f"Base package 1 (v1.1.0) processed: {param}"

if __name__ == "__main__":
    hatch_mcp.logger.info("Starting MCP server for base_pkg_1 v1.1.0")
